...
import com.yongxing.activity.demo01.adapter.TabLayoutFragment2Adapter;
...
public class TabLayoutFragment2 extends Fragment implements TabLayout.OnTabSelectedListener {
    ...
    private int[] mTabImgs = new int[]{R.drawable.label_viewgallery, R.drawable.location, R.drawable.label_set, R.drawable.person};
...
//        mViewPager.setCurrentItem(0);
        mTabLayout.getTabAt(0).setIcon(R.drawable.label_viewlist_click);
        mTabLayout.getTabAt(1).setIcon(R.drawable.location);
        mTabLayout.getTabAt(2).setIcon(R.drawable.label_set);
...
//        setDefaultFragment();
    ...
    public void initFragmentList() {
        ...
        mFragments.add(VideoFragment.newInstance(getString(R.string.item_location)));
...
//        setTabSelectedState(tab);
        ...
        switch (position) {
            case 0:
                tab.setIcon(R.drawable.label_viewlist_click);
                break;
            case 1:
                tab.setIcon(R.drawable.location_fill);
                break;
            case 2:
                tab.setIcon(R.drawable.label_set_click);
                break;
            case 3:
...
//        setTabUnSelectedState(tab);
    ...
    private void setTabSelectedState(TabLayout.Tab tab) {
        ...
        tabText.setTextColor(ContextCompat.getColor(getActivity(), R.color.blue));
        String s = tabText.getText().toString();
        if (getString(R.string.item_home).equals(s)) {
            tabIcon.setImageResource(R.drawable.label_viewlist_click);
            ...
            tabIcon.setImageResource(R.drawable.label_set_click);
    ...
    private void setTabUnSelectedState(TabLayout.Tab tab) {
        ...
        String s = tabText.getText().toString();
        if (getString(R.string.item_home).equals(s)) {
            tabIcon.setImageResource(R.drawable.label_viewgallery);
        } else if (getString(R.string.item_location).equals(s)) {
            tabIcon.setImageResource(R.drawable.location);
        } else if (getString(R.string.item_like).equals(s)) {
            tabIcon.setImageResource(R.drawable.label_set);
        } else if (getString(R.string.item_person).equals(s)) {
