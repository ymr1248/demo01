...
public class TextTabFragment extends Fragment implements View.OnClickListener {
    ...
    private void setDefaultFragment() {
        ...
        setTabState(mTHome, R.drawable.label_viewlist_click, getColor(R.color.blue));
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_location:
                setTabState(mTLocation, R.drawable.location_fill, getColor(R.color.blue));
                switchFrgment(1);
                break;
            case R.id.tv_like:
                setTabState(mTLike, R.drawable.label_set_click, getColor(R.color.blue));
                switchFrgment(2);
                break;
            case R.id.tv_person:
                setTabState(mTMe, R.drawable.person_fill, getColor(R.color.blue));
                switchFrgment(3);
                break;
        }
    }
    ...
    private void switchFrgment(int i) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                transaction.replace(R.id.sub_content, mVideoFragment);
                break;
            case 2:
    ...
    private void resetTabState() {
        setTabState(mTHome, R.drawable.label_viewgallery, getColor(R.color.black_1));
        setTabState(mTLocation, R.drawable.location, getColor(R.color.black_1));
        setTabState(mTLike, R.drawable.label_set, getColor(R.color.black_1));
