				...
				<div class="tables">
					<div class="bs-example widget-shadow"
						...
						<div class="row">
							...
							<div class="form-body">
								<form action="addSpaceOrder" method="post" enctype="multipart/form-data"
									  class="bs-example bs-example-form" role="form" name="touxiangform">
									<div class=" form-group-lg">
										<label><i class="fa fa-user fa-fw"></i>充值空间大小(g)：</label>
										<input type="text" class="form-control" maxlength="16"
                                               onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"
											   id="spaceSize" name="spaceSize" placeholder="空间大小" required>
									</div>
                                    <div class=" form-group-lg">
                                        <label><i class="fa fa-user fa-fw"></i>充值时间(月)：</label>
                                        <input type="text" class="form-control" maxlength="8"
                                               onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"
                                               id="extraMoths" name="extraMoths" placeholder="空间大小" required>
                                    </div>
                                    <div class=" form-group-lg">
                                        <label><i class="fa fa-user fa-fw"></i>用户：</label>
