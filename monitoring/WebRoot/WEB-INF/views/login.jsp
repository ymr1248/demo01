...
<div  id="login">
    <div>
        ...
        <div class="login">
            <form action="managerLogin" method="post" class="container offset1 loginform">

                <div class="pad">
                    <div class="control-group">
                        <div class="controls">
                            <label for="managerAccount" class="control-label fa fa-user"></label>
                            <input id="managerAccount" type="text" name="managerAccount" maxlength="16" placeholder="账户" tabindex="1" required autofocus="autofocus" class="form-control input-medium">
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
