        ...
        <div class="tables">
            <div class="bs-example widget-shadow"
                ...
                <div class="row">
                    ...
                    <div class="form-body">
                        <form action="monitorgroup_add" method="post" enctype="multipart/form-data"
                            ...
                            <div class=" form-group-lg">
                                ...
                                <input type="text" class="form-control" maxlength="16"
                                       id="groupName" name="groupName" placeholder="机器组名" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>类型名称：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="groupType" name="groupType" placeholder="类型名称" required>
                            </div>
