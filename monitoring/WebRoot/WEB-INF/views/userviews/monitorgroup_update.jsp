        ...
        <div class="tables">
            <div class="bs-example widget-shadow"
                ...
                <div class="row">
                    ...
                    <div class="form-body">
                        <form action="monitorgroup_update" method="post" enctype="multipart/form-data"
                              class="bs-example bs-example-form" role="form" name="touxiangform">
                            <input class="hidden" name="groupId" value="${list.groupId }"/>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>机器组名：</label>
                                <input type="text" class="form-control" maxlength="16"
                                       id="groupName" name="groupName" value="${list.groupName }" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>类型名称：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="groupType" name="groupType" value="${list.groupType }" required>
                            </div>
