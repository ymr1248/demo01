...
<div id="page-wrapper">
    <div class="main-page">
        ...
        <h3 class="title1">机器组列表:</h3>
        <div class="grid_3 grid_5 widget-shadow">
            <div>
                <h3>
                    <a href="toMonitorgroup_add"><span class="label label-success">添加机器组</span></a>
                </h3>
            </div>
            <div>
                ...
                <table class="table">
                    <c:if test="${list!=null}">
                        ...
                        <tr>
                            ...
                            <th class="manager-border">机器组名</th>
                            <th class="manager-border">组名类型</th>
