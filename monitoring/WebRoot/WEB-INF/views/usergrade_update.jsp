        ...
        <div class="tables">
            <div class="bs-example widget-shadow"
                ...
                <div class="row">
                    ...
                    <div class="form-body">
                        <form action="updateUserGrade" method="post"
                              class="bs-example bs-example-form" role="form" name="touxiangform">
                            <input type="text" class="hidden"
                                   id="id" name="id" value="<%=map1.get("id")%>">
                            <input type="text" class="hidden"
                                   id="userId" name="userId" value="<%=managerId%>">
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>等级类型</label>
                                <input type="text" class="form-control" maxlength="12" readonly="true"
                                       id="gradetype" name="gradetype" placeholder="等级类型"
                                       value="<%=map1.get("gradetype")%>">
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>等级名称</label>
                                <input type="text" class="form-control" maxlength="12"
                                       value="<%=map1.get("gradename")%>"
